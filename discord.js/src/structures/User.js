...
class User extends Base {
  ...
  _patch(data) {
     ...
     * @property {Snowflake} identityGuildId The guild id of the clan
     * @property {boolean} identityEnabled Whether the clan identity is enabled
     * @property {string} tag The clan tag
  ...
  equals(user) {
    return (
      ...
      this.clan?.identityGuildId === user.clan?.identityGuildId &&
      this.clan?.identityEnabled === user.clan?.identityEnabled &&
      this.clan?.tag === user.clan?.tag &&
      this.clan?.badge === user.clan?.badge &&
  ...
  _equals(user) {
    return (
      ...
      ('avatar_decoration_data' in user
        ...
        : true) &&
      ('clan' in user
        ? this.clan?.identityGuildId === user.clan?.identity_guild_id &&
          this.clan?.identityEnabled === user.clan?.identity_enabled &&
          this.clan?.tag === user.clan?.tag &&
          this.clan?.badge === user.clan?.badge
        : true) &&
